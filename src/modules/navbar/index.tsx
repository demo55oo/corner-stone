        ...
        {localStorage.getItem("token") && (
          <>
            <Grid item textAlign={"center"}>
              ...
              <Typography component={"div"}>Chat</Typography>
            </Grid>
            <Grid item textAlign={"center"}>
              <img src={messageIcon} alt="messageIcon" />
              <Typography component={"div"}>Inbox</Typography>
            </Grid>
            <Grid item textAlign={"center"}>
              <img
                src={messageIcon}
              ...
              />
              <Typography component={"div"}>Messages</Typography>
              {openMessages && (
                <List
                  ref={refMessage}
                  sx={{
                  ...
                  >
                    ...
                    <ListItem disablePadding>
                      <ListItemButton>
                        ...
                        <ListItemText primary="My Saved Ads" />
                      </ListItemButton>
                    </ListItem>
                    <Link to={"/"}>
                      <ListItem disablePadding>
