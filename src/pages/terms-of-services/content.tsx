  ...
  return (
    <div>
      ...
      <p>
        ...
        the agreement that operates between You and All Gabal Global group
        subsidiaries. These Terms and Conditions set out the rights and
        obligations of all users regarding the use of the Service. By accessing
        ...
        then You may not access the Service. -You represent that you are over
        the age of 18. The Company does not permit those under 18 to use the
      ...
      <p>
        If you are a paid subscriber, your subscription will end at the
        expiration date and will no longer renew. There will be no refunds for
        any unused period of your subscription.
      </p>

      <p>4-User content</p>
      <p>Please refer to “uploaded content agreement” section</p>

      <p>5-"AS IS" and "AS AVAILABLE" Disclaimer</p>
      <p>
