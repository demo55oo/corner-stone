...
const WebContent = () => {
  ...
  const dateFormats: any = [
    { label: "MM/DD/YY", value: "MM/DD/YY", id: 1 },
    { label: "DD/MM/YY", value: "DD/MM/YY", id: 2 },
    { label: "YY/MM/DD", value: "YY/MM/DD", id: 3 },
  ];
  return (
    <AdminLayout>
          ...
          <div>
            ...
            >
              ...
              <SimpleSelect
                ...
                onChange={(e) =>
                  siteInfoFormik.setFieldValue("dateFormat", e.target.value)
                }
              />
            </div>
            <Button
