const content = () => {
  return (
    <div>
      ...
      <p>Our pledge</p>
      <p>
        We will never share your personal data with any third party for any
        reason whatsoever.
      </p>
      <div style={{ width: "100%", background: "#6A6F77" }}>
        <h2>Types of Data Collected Personal Data</h2>
      </div>
      <p>
        While using Our Service, We may ask you to provide us with certain
        personally identifiable information that can be used to contact or
        identify you. Personally identifiable information may include, but is
        not limited to: Email address, Name, Usage Data
      </p>
      <p>Usage Data</p>
      <p>
      ...
      <p>
        ...
        Service through the following third-party Social Media Services: Google,
        Facebook, TwitterIf You decide to register through or otherwise grant us
        access to a third-Party Social Media Service, We may collect Personal
        data that is already associated with Your Third-Party Social Media
